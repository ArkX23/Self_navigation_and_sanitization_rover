...
: ${AMENT_CURRENT_PREFIX:="/home/arjun/ldlidar_ros2_ws/install/nav2_mapless"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_mapless/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_mapless/environment/path.sh"
